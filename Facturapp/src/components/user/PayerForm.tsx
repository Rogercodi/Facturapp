...
export function PayerForm() {
  const { iduser, updatePayer, greenMessage, redMessage, setGreenMessage, setRedMessage, closeErrorWindow, name } = useContext(FacturappContext) as FacturappContextType;
