...
function UserNav() {
  ...
  <div className="flex items-center flex-shrink-0 text-white mr-6">
    ...
    <Link to={'/user'} ><span className="font-semibold text-xl tracking-tight">FACTURAPP</span></Link>
  </div>
  ...
  <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    ...
    <div>
      <Link to="/user/myprofile" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Editar Perfil</Link>
    </div>
  </div>
</nav>
{/* <Outlet /> */}
