...
function UserNav() {
  ...
  <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    ...
    <div>
      <a href="/user/myprofile" className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">Editar Perfil</a>
    </div>
  </div>
</nav>
{/* <Outlet /> */}
